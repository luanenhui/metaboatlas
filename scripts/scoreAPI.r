...
# help(package="httr")
# 
# httr::GET(url="http://127.0.0.1/apt/getSpectra?instrument=ESI-QTOF&ionMode=Positive&species=human")



response = httr::GET(url="http://127.0.0.1:8000", path="api/getSpectra", query=list(
  instrument="ESI-QTOF",
  ionMode="Positive",
  species="human"))

spectra = jsonlite::fromJSON(content(result,"text"), simplifyVector = FALSE)
